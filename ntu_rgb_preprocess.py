...
class DataSetLoader(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # cat=concatenate 将两个tensor按某个维度拼接在一起
...
def load_data(args):
    train_annotation = './ntu-dataset/all_train_sample.pkl'
    test_annotation = './ntu-dataset/all_test_sample.pkl'
...
# for x1,x2,x3,x4,x5,traversal,label in enumerate(x):
#     print(x1.shape)
#     print(x2.shape)
#     print(x3.shape)
#     print(x4.sahpe)
